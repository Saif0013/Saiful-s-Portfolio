...
k_clusters = kmeans_estimator.fit(area_pts)
...
kmeans_estimator = KMeans(n_clusters=5, random_state=0)
k_clusters = kmeans_estimator.fit(area_pts2)
...
k_clusters = kmeans_estimator.fit(sample_pts1)
...
# Initialising the algorithm
kmeans_estimator = KMeans(n_clusters=4, random_state=0)
k_clusters = kmeans_estimator.fit(sample_pts2)
clusterCenters = k_clusters.cluster_centers_
